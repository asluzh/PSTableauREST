...
redirect_from: ["/PowerShell/PSTableauREST/Update-TSFlowConnection/", "/PowerShell/PSTableauREST/update-tsflowconnection/", "/PowerShell/update-tsflowconnection/"]
schema: 2.0.0
title: Update-TSFlowConnection
---

# Update-TSFlowConnection
...
```
Update-TSFlowConnection [-FlowId] <String> [-ConnectionId] <String> [[-ServerAddress] <String>]
