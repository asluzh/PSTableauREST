...
redirect_from: ["/PowerShell/PSTableauREST/Get-TSGroup/", "/PowerShell/PSTableauREST/get-tsgroup/", "/PowerShell/get-tsgroup/"]
schema: 2.0.0
title: Get-TSGroup
---
...
```
Get-TSGroup [[-Filter] <String[]>] [[-Sort] <String[]>] [[-Fields] <String[]>] [[-PageSize] <Int32>]
