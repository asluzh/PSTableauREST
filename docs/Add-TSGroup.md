...
redirect_from: ["/PowerShell/PSTableauREST/Add-TSGroup/", "/PowerShell/PSTableauREST/add-tsgroup/", "/PowerShell/add-tsgroup/"]
schema: 2.0.0
title: Add-TSGroup
---
...
```
Add-TSGroup [-Name] <String> [[-MinimumSiteRole] <String>] [[-DomainName] <String>]
