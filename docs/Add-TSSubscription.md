...
online version:
redirect_from: ["/PowerShell/PSTableauREST/Add-TSSubscription/", "/PowerShell/PSTableauREST/add-tssubscription/", "/PowerShell/add-tssubscription/"]
schema: 2.0.0
title: Add-TSSubscription
---
...
### ServerSchedule
```
Add-TSSubscription -Subject <String> -Message <String> -UserId <String> -ContentType <String>
