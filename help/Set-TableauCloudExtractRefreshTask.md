...
schema: 2.0.0
title: Set-TableauCloudExtractRefreshTask
---

# Set-TableauCloudExtractRefreshTask
...
### Workbook
```
Set-TableauCloudExtractRefreshTask -TaskId <String> -WorkbookId <String> [-Type <String>] [-Frequency <String>]
...
### Datasource
```
Set-TableauCloudExtractRefreshTask -TaskId <String> -DatasourceId <String> [-Type <String>]
